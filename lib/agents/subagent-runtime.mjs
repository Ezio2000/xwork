...
function buildSubagentHistory({ objective, task, brief, expectedOutput, instructions, parentSummary, allowedToolNames, allowSubagents, maxTurns }) {
  ...
  const systemParts = [
    ...
    'Keep the final result short and use plain language: prefer one short paragraph or 3-6 bullets. Avoid unnecessary elaboration, repetition, or boilerplate. State findings directly.',
    ...
    'Expected output: concise result for the parent, preferably under 6 bullets unless the user contract below says otherwise.',
