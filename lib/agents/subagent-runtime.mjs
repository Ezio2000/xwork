...
function buildSubagentHistory({ objective, task, brief, expectedOutput, instructions, parentSummary, allowedToolNames, allowSubagents, maxTurns }) {
  ...
  const systemParts = [
    ...
    '  - 3-5 short bullet points max. One line per bullet. No paragraphs.',
    ...
    'Expected output: raw facts only. 3-5 bullets. No introductions, conclusions, or meta. If the parent needed prose it would not have delegated.',
