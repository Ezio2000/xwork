...
const ASSERTED_TOOL_ACTION_PATTERNS = [
  ...
  /(?:I|I'll|I will|Let me|Now I|Next I|First I)[^.!?\n]*(?:open|click|type|fill|send|screenshot|capture|search|fetch|read|write|run|execute|inspect|check|download|upload|save|delete|modify|navigate|refresh|wait)/i,
  /(?:opened|clicked|typed|filled|sent|screenshotted|captured|searched|fetched|read|wrote|ran|executed|inspected|downloaded|uploaded|saved|deleted|modified|navigated|refreshed)\b/i,
];
