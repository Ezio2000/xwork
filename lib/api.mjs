...
function buildSystemPrompt(messages, tools) {
  const parts = [
    [
      ...
      'IMPORTANT: For any question about "today", "current", "recent", or time-sensitive topics, you must first determine the current date before searching or answering. Do not assume you know the current date.',
    ].join('\n'),
  ];
