...
function buildSystemPrompt(messages, tools) {
  const parts = [
    [
      ...
      'IMPORTANT: For any question about "today", "current", "recent", or time-sensitive topics, you MUST call get_current_time to confirm the exact date BEFORE calling web_search or any other tool. Do not assume you know the current date.',
    ].join('\n'),
  ];
