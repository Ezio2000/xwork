function systemPrompt() {
  return [
    ...
    '',
    '## Call discipline',
    '- Call delegate_task FIRST, write text AFTER. Do NOT write any preamble before calling tools — not even a short one. The user sees tool calls immediately; text before tools adds latency with no value.',
    '',
