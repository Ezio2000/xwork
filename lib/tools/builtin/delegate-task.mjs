function systemPrompt() {
  return [
    ...
    '',
    '## Call discipline',
    '- When you decide to call delegate_task, do it immediately. Do NOT write a text preamble announcing what you are about to do ("I will launch N subagents...", "Let me start by..."). The tool call itself communicates the plan.',
    '- Keep your text response minimal while subagents run. You can write a summary after they complete.',
    '',
    ...
    '- Use expectedOutput to tell the subagent exactly what to output. Subagent output is pasted verbatim into your context — every word costs tokens. Request the minimum: "list the findings in 3 bullets" rather than "write a comprehensive report".',
