function systemPrompt() {
  return [
    ...
    '- Use expectedOutput to request a concise result, preferably one short paragraph or 3-6 bullets with findings, evidence, assumptions, blockers, and source/file references when relevant.',
...
const TOOL_ALLOWLIST = ['web_search', 'get_current_time', 'calculator', 'uuid_gen', 'delegate_task'];
