...
import { validateChannelPayload, validateOptionalSafeId } from './schema.mjs';
...
export async function createChannel(payload) {
  const { name, baseUrl, apiKey, models, maxTokens, extraHeaders, pricing } = validateChannelPayload(payload || {});
...
export async function updateChannel(id, payload) {
  ...
  return updateConfig((cfg) => {
    ...
    const { name, baseUrl, apiKey, models, maxTokens, extraHeaders, pricing } = patch;
